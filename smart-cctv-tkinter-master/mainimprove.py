...
from dynamicZone import rect_noise, open_zone_config  # Import `open_zone_config`
...
def main_app():
    if login_success:            
        ...
        # btn2 = tk.Button(frame1, text='Rectangle', font=('Microsoft YaHei UI Light',25,'bold') , height=90, width=300, fg='orange', command=lambda: open_zone_config(window), compound='left', image=btn2_image)
