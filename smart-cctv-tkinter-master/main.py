...
icon = Image.open('icons/Baksters.png')
...
btn1 = tk.Button(frame1, text='Configuration', height=90, width=300, fg='green', image=btn1_image, compound='left', command=openenv)
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10))

btn2 = tk.Button(frame1, text='Rectangle', height=90, width=180, fg='orange', command=lambda: rect_noise('entrance'), compound='left', image=btn2_image)
btn2['font'] = btn_font
